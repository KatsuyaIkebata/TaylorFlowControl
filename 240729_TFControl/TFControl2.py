...
# 使用するGPIOピンの設定
pin1, pin2, pin3, pin4 = 6, 13, 19, 26 # 使用するGPIOピン番号を指定
...
# GUIの中身
tk.Label(root, text="Valve 1 open delay (from pump 1 infuse):").pack()
delay_entry_1A = tk.Entry(root)
delay_entry_1A.pack()

update_button_1A = tk.Button(root, text="Update valve 1 open delay", command=update_delay_1A)
update_button_1A.pack()

status_Label_1A = tk.Label(root, text=f"Current valve 1 open delay: {valve_delay_1A} seconds")
status_Label_1A.pack()

tk.Label(root, text="Valve 1 close delay (from pump 1 stop):").pack()
delay_entry_1C = tk.Entry(root)
delay_entry_1C.pack()

update_button_1C = tk.tk.Button(root, text="Update valve 1 close delay", command=update_delay_1C)
update_button_1C.pack()

status_Label_1C = tk.Label(root, text=f"Current valve 1 close delay: {valve_delay_1C} seconds")
status_Label_1C.pack()


tk.Label(root, text="Valve 2 open delay (from pump 2 infuse):").pack()
delay_entry_2A = tk.Entry(root)
delay_entry_2A.pack()

update_button_2A = tk.Button(root, text="Update valve 2 open delay", command=update_delay_2A)
update_button_2A.pack()

status_Label_2A = tk.Label(root, text=f"Current valve 2 open delay: {valve_delay_2A} seconds")
status_Label_2A.pack()

tk.Label(root, text="Valve 2 close delay (from pump 2 stop):").pack()
delay_entry_2C = tk.Entry(root)
delay_entry_2C.pack()

update_button_2C = tk.Button(root, text="Update valve 2 close delay", command=update_delay_2C)
update_button_2C.pack()

status_Label_2C = tk.Label(root, text=f"Current valve 2 close delay: {valve_delay_2C} seconds")
status_Label_2C.pack()


tk.Label(root, text="Valve 3 open delay (from pump 1 infuse):").pack()
delay_entry_3A = tk.Entry(root)
delay_entry_3A.pack()

update_button_3A = tk.Button(root, text="Update valve 3 open delay", command=update_delay_3A)
update_button_3A.pack()

status_Label_3A = tk.Label(root, text=f"Current valve 3 open delay: {valve_delay_3A} seconds")
status_Label_3A.pack()

tk.Label(root, text="Valve 3 close delay (from pump 1 stop):").pack()
delay_entry_3C = tk.Entry(root)
delay_entry_3C.pack()

update_button_3C = tk.Button(root, text="Update valve 3 close delay", command=update_delay_3C)
update_button_3C.pack()

status_Label_3C = tk.Label(root, text=f"Current valve 3 close delay: {valve_delay_3C} seconds")
status_Label_3C.pack()


tk.Label(root, text="Valve 4 open delay (from pump 2 infuse):").pack()
delay_entry_4A = tk.Entry(root)
delay_entry_4A.pack()

update_button_4A = tk.Button(root, text="Update valve 4 open delay", command=update_delay_4A)
update_button_4A.pack()

status_Label_4A = tk.Label(root, text=f"Current valve 4 open delay: {valve_delay_4A} seconds")
status_Label_4A.pack()

tk.Label(root, text="Valve 4 close delay (from pump 2 stop):").pack()
delay_entry_4C = tk.Entry(root)
delay_entry_4C.pack()

update_button_4C = tk.Button(root, text="Update valve 4 close delay", command=update_delay_4C)
update_button_4C.pack()

status_Label_4C = tk.Label(root, text=f"Current valve 4 close delay: {valve_delay_4C} seconds")
