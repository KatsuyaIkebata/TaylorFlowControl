...
with open(csv_filename, mode='w', newline='') as file:
    ...
    writer.writerow([datetime.now().isoformat(), 'Pump 1', f'Set Diameter {SyringeDiameter}'])
    writer.writerow([datetime.now().isoformat(), 'Pump 1', f'Set Infuse Rate {TotalRate} mL/min'])
    ...
    writer.writerow([datetime.now().isoformat(), 'Pump 2', f'Set Diameter {SyringeDiameter}'])
    writer.writerow([datetime.now().isoformat(), 'Pump 2', f'Set Infuse Rate {TotalRate} mL/min'])
