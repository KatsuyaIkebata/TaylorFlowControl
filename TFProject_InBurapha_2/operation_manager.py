...
class Operation:
    ...
    def __init__(self, config: Config):
        ...
        # for i in range(len(self.config.serial_port)):
        #     self.Pump[i].ser = serial.Serial()
        #     self.Pump[i].ser.baudrate = self.config.baudrate
        #     self.Pump[i].ser.port = self.config.serial_port[i]
        #     self.Pump[i].ser.timeout = 0
        #     self.Pump[i].ser.open()
        #     # self.Pump[i].ser = serial.Serial(port=self.config.serial_port[i], baudrate=self.config.baudrate, timeout=1)
